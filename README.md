...
这个仓库是一套 **面向 AI 产业趋势的美股投资研究工作流**。

它把 AI 科技新闻、论文、开源项目、社区舆情、公司基本面、技术面和下周归因整理成一份可审查的中文研究周报。它不是交易机器人，不连接实盘账户，不下单，也不提供个人化仓位建议。

一句话说：**用多 Agent 把 AI 产业信息转成有证据链、有反证条件、有复盘闭环的美股研究报告。**
